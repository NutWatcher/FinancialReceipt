...
const BillManage = ({ dispatch, companyList, list: dataSource, loading, total, page: current, formList }) => {
  ...
  return (
    <Page>
      <BillSearchForm  dispatch={dispatch} companyList={companyList} formList={formList} />
